    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('available_languages',
                 django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=30),
                                                           null=True, size=None)),
            ],
        ),
        migrations.AddField(
            ...
            name='guest',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_review_about_guest',
                                    to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='guestreview',
            name='host',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_review_by_host',
                                    to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='user',
