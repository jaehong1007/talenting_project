    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_categories', models.SmallIntegerField(
                    choices=[(1, 'Entertainment'), (2, 'SightSeeing'), (3, 'Eat, Drink'), (4, 'Sports'), (5, 'Other')],
                    default=1, verbose_name='categories')),
                ...
                ('country', models.CharField(
                    choices=[('AF', 'Afghanistan'), ('AX', 'Åland Islands'), ('AL', 'Albania'), ('DZ', 'Algeria'),
                             ...
                             ('ZW', 'Zimbabwe')], max_length=2, verbose_name='Country')),
                ...
                ('participants',
                 models.ManyToManyField(blank=True, related_name='participants', to=settings.AUTH_USER_MODEL,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                             to=settings.AUTH_USER_MODEL)),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments',
                                            to='event.Event')),
            ],
            options={
                'ordering': ['created_at'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='event_photo',
                                            to='event.Event')),
            ],
        ),
    ]
